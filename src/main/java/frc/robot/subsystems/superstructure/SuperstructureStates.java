...
public class SuperstructureStates {
    ...
    public SuperstructureStates(){
        ...
        Intake = new SuperstructureState(-18*Constants.endEffectorPivotGearRatio / 360, 0.2, 94);
        ...
        CoralL3 = new SuperstructureState(85*Constants.endEffectorPivotGearRatio / 360, 38, 15);
        CoralL4 = new SuperstructureState(63*Constants.endEffectorPivotGearRatio / 360, 76, 15);
