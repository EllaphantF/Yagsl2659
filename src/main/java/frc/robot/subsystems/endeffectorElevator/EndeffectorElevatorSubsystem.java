...
public class EndeffectorElevatorSubsystem extends SubsystemBase {
  ...
  public EndEffectorElevatorState targetState;
  public double state = 0;
  public boolean hasCoral = false;
  public boolean hasAlgae = false;
  public EndEffectorElevatorStates STATE = new EndEffectorElevatorStates();
  ...
  public void setPreScoreCoralPos(Integer level){ //sets up elevator and EE pivot for pre-score position for drive-up 
    // elevatorTarget = 0; //reference constants or arm pos file 
    // pivotTarget = 0;
    targetState = STATE.PreScoreCoral;
  }

  public void setScoreCoralPos(Double level){ //sets up elevator and EE pivot for score position for drive-up 
    // elevatorTarget = 0; //reference constants or arm pos file 
    // pivotTarget = 0;
    if (level == 1) targetState = STATE.StageL1;
    if (level == 2) targetState = STATE.StageL2;
    if (level == 3) targetState = STATE.StageL3;
    if (level == 4) targetState = STATE.StageL4;
  }
